...
export default function DashProfile() {
    ...
    const handleImageChange= (e) => {
        ...
        setImageFileUrl(URL.createObjectURL(file));    // create temp url link for image which is selected
    };
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form action="" className='flex flex-col gap-4'>
            ...
            <img src={imageFileUrl || currentUser.rest.profilePicture} alt="" className={`rounded-full  object-cover w-full h-full border-8 
            border-[lightgray] ${imageFileUploadProgress && imageFileUploadProgress < 100 && 'opacity-60'}`} />
                ...
                {imageFileUploadError && (   
                 ...
                 {/* Alert will on show if there is error */}
